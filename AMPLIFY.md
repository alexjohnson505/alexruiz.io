Before this page was available on GitHub Pages, we had set it up to run on AWS Amplify. While these instructions are no longer used, we're saving here for future reference. 
...
Note: GitHub pages only support /dist for sub-directory.
